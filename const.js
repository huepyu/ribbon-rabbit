...
const members = [
  // 운영진: 리본
  { kingdom: KINGDOM_A, name: '단밤', ratio: 512, prefix: '★' },
  { kingdom: KINGDOM_A, name: '주녕코', ratio: 1024, prefix: '☆' },
  ...
  { kingdom: KINGDOM_B, name: '단밤2', ratio: 2, prefix: '☆' },
  ...
  { kingdom: KINGDOM_A, name: '엘리', ratio: 2048, prefix: '☆' },
  ...
  { kingdom: KINGDOM_A, name: '밍공이', ratio: 256, prefix: '' },
  { kingdom: KINGDOM_A, name: '레미마르', ratio: 512, prefix: '' },
